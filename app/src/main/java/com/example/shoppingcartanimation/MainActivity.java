...
public class MainActivity extends AppCompatActivity implements FoodAdapter.FoodActionCallback {
    ...
    private TextView goods_all_pricetv, good_numtv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goods_all_pricetv = findViewById(R.id.goods_all_pricetv);
        good_numtv = findViewById(R.id.good_numtv);

        findViewById(R.id.goods_submit_tv).setOnClickListener(v -> {
